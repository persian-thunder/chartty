...
SHADER     = os.path.join(os.path.dirname(os.path.abspath(__file__)), "shader.py")
CHARS_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "chars.txt")
PAL_FILE   = os.path.join(os.path.dirname(os.path.abspath(__file__)), "palette.txt")
CHARS      = " ·:│▒█"
